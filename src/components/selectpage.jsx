...
function Select(props) {
  return (
    <div id={props.name} name={props.name} className={"flex flex-col h-screen space-y-5 relative grow " + props.bg}>
      ...
      <a className="btn rounded-none btn-accent border-0 no-animation black-transparent-bg-30 w-auto h-1/6 font-transparent font-anton text-4xl safe-padding absolute bottom-0 w-screen" href={props.next}>Proximo</a>
    </div>
  )
}
